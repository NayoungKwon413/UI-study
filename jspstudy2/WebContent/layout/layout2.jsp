...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span class="w3-bar-item w3-right">Petmily</span>
</div>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <c:if test="${empty sessionScope.login}">
  	...
  	<a href="${path}/model2/member/joinForm.me" class="w3-bar-item w3-button">회원가입</a>
  </c:if>
  ...
  <c:if test="${!empty sessionScope.login}">
    ...
    <div class="w3-col s8 w3-bar">
      <span>환영합니다, <strong>${sessionScope.login}님!</strong></span><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="${path}/model2/dailycare/dailycare.day" class="w3-bar-item w3-button w3-padding"><i class="fa fa-eye fa-fw"></i>데일리케어</a>
    <a href="${path}/model2/calendar/calendar.cal" class="w3-bar-item w3-button w3-padding"><i class="fa fa-bell fa-fw"></i>캘린더</a>
    <a href="${path}/model2/board/list.do" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>자유게시판</a>
    <!-- 
  ...
  <div class="w3-row-padding w3-margin-bottom">
    <div class="w3-quarter">
      <div class="w3-container w3-red w3-padding-16">
        <div class="w3-left"><i class="fa fa-cog fa-fw"></i></div>
    ...
    <div class="w3-quarter">
      <div class="w3-container w3-teal w3-padding-16">
        <div class="w3-left"><i class="fa fa-bell fa-fw"></i></div>
        <div class="w3-clear"></div>
