...
public class Main3 {
	...
	public static void main(String[] args) {
		...
		System.out.println("키가 180 이상인 학생 레코드를 조회하기");
		map.clear();
		map.put("height", 180);
		...
		System.out.println("1학년 중 키가 180 이상인 학생 레코드 조회하기");
		map.clear();
		map.put("grade", 1);
		map.put("height", 180);
		...
		System.out.println("1학년 중 키가 180 이상인 학생 레코드 조회하기(select3)");
		map.clear();
		map.put("grade", 1);
		map.put("height", 180);
		list = session.selectList(NS + "select3", map);
		...
		System.out.println("1학년 중 키가 180 이상이고 몸무게 80 이상인 학생의 레코드 조회하기");
		map.clear();
		map.put("grade", 1);
		map.put("height", 180);
		map.put("weight", 80);
